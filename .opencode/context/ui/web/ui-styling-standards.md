...
<div class="mx-auto w-full lg:w-3/4 xl:w-1/2">Content</div>
```
...
<div class="bg-gray-900 p-8">
	<div class="rounded-lg bg-white p-6 text-gray-900">Light card content</div>
</div>

<!-- Dark card on light background -->
<div class="bg-gray-50 p-8">
	<div class="rounded-lg bg-gray-900 p-6 text-white">Dark card content</div>
</div>
```
...
<div class="container mx-auto max-w-7xl px-4">Content</div>

<!-- Full-width section with contained content -->
<section class="w-full bg-gray-50">
	<div class="container mx-auto max-w-6xl px-4 py-12">Content</div>
</section>
```
...
```html
<!-- Heading scale -->
<h1 class="text-4xl font-bold md:text-5xl lg:text-6xl">Main Heading</h1>
<h2 class="text-3xl font-semibold md:text-4xl">Section Heading</h2>
<h3 class="text-2xl font-semibold md:text-3xl">Subsection</h3>
<h4 class="text-xl font-medium md:text-2xl">Minor Heading</h4>

<!-- Body text -->
<p class="text-base leading-relaxed md:text-lg">Body text</p>
...
<!-- Interactive card -->
<div
	class="bg-card text-card-foreground cursor-pointer rounded-lg p-6 shadow-md transition-shadow hover:shadow-lg"
>
	<h3 class="mb-2 text-xl font-semibold">Interactive Card</h3>
...
<div class="space-y-2">
	...
	<input
		type="email"
		class="border-input focus:ring-ring w-full rounded-lg border px-4 py-2 transition-all focus:border-transparent focus:ring-2"
...
<div class="space-y-2">
	...
	<textarea
		class="border-input focus:ring-ring w-full resize-none rounded-lg border px-4 py-2 transition-all focus:border-transparent focus:ring-2"
		rows="4"
